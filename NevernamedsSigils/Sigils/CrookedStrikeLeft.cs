    ...
    public class CrookedStrikeLeft : ExtendedAbilityBehaviour
    {
        public static void Init()
        {
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Crooked Strike Left", "[creature] will attack the space to the left of it's intended target.",
                      ...
                      categories: new List<AbilityMetaCategory> { AbilityMetaCategory.Part1Rulebook, AbilityMetaCategory.Part1Modular, Plugin.Part2Modular, AbilityMetaCategory.GrimoraRulebook, AbilityMetaCategory.Part3Rulebook },
                      powerLevel: 0,
                      stackable: false,
