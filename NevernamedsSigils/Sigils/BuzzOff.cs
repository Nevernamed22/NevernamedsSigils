...
namespace NevernamedsSigils
{
    public class BuzzOff : Strafe
    {
        public static void Init()
        {
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Buzz Off", "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil and leave a mayfly in its old place. A mayfly is defined as 1 power, 1 health, airborne, brittle.",
                      ...
                      tex: Tools.LoadTex("NevernamedsSigils/Resources/Sigils/buzzoff.png"),
                       pixelTex: Tools.LoadTex("NevernamedsSigils/Resources/PixelSigils/buzzoff_pixel.png"));
        ...
        public override IEnumerator PostSuccessfulMoveSequence(CardSlot cardSlot)
        {
            ...
            {
                CardInfo mayfly = CardLoader.GetCardByName("SigilNevernamed SwarmedMayfly");
