...
namespace NevernamedsSigils
{
    public class Rememberance : AbilityBehaviour
    {
        ...
        {
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Rememberance", "When [creature] is played, it's owner may search their graveyard for a card. This sigil is replaced by that cards sigils.",
                      typeof(Rememberance),
