    ...
    public class ChaosStrike : AbilityBehaviour
    {
        public static void Init()
        {
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Chaos Strike", "When [creature] is drawn, this sigil is replaced by a random strike modifier sigil.",
                      ...
                      pixelTex: Tools.LoadTex("NevernamedsSigils/Resources/PixelSigils/chaosstrike_pixel.png"));
        ...
        {
            if (Singleton<PlayerHand>.Instance is PlayerHand3D) { (Singleton<PlayerHand>.Instance as PlayerHand3D).MoveCardAboveHand(base.Card); }
