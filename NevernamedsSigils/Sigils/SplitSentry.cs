...
{
    public class SplitSentry : AbilityBehaviour
    {
        public static void Init()
        {
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Split Sentry", "When a creature moves into the space opposing [creature], any creatures to their left or right are dealt 1 damage.",
                      ...
                      stackable: false,
                      opponentUsable: true,
                      tex: Tools.LoadTex("NevernamedsSigils/Resources/Sigils/splitsentry.png"),
                      pixelTex: Tools.LoadTex("NevernamedsSigils/Resources/PixelSigils/splitsentry_pixel.png"));
