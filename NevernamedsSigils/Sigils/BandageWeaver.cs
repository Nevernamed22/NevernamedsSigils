...
namespace NevernamedsSigils
{
    public class BandageWeaver : AbilityBehaviour
    {
        ...
        {
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Bandage Weaver", "At the end of the turn, [creature] will heal the cards to its left and right for 1 health.",
